#ifndef BOSCH_BMI270_H
#define BOSCH_BMI270_H
...
/** @brief
*/
#define BOSCH_BMI270_FEAT_ENABLE        (0x01 << 0x00) //Enable features

/** @brief
*/
#define BOSCH_BMI270_FEAT_DISABLE       (0x00 << 0x00)//Disable features
